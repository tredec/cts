...
var init = () => {
    ...
    // B
    {
        ...
        B = theory.createUpgrade(3, currency, new ExponentialCost(1e4*2.5, costConst*Math.log2(2)));
    ...
    // C
    {
        ...
        C = theory.createUpgrade(4, currency, new ExponentialCost(1e5*2.5, costConst*Math.log2(2.995)));
    ...
    // D
    {
        ...
        D = theory.createUpgrade(5, currency, new ExponentialCost(1e7*2.5, costConst*Math.log2(4.97)));
